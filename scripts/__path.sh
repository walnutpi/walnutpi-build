...
PATH_ASSET="${PATH_PROJECT_DIR}/scripts/boot/deb"
...
TMP_IMG_DISK2="${PATH_TMP}/PART2-${BOARD_NAME}-${ENTER_os_ver}_${ENTER_rootfs_type}"
TMP_mount_disk1="${PATH_TMP}/MOUNT-PART1-${BOARD_NAME}-${ENTER_os_ver}_${ENTER_rootfs_type}"
TMP_mount_disk2="${PATH_TMP}/MOUNT-PART2-${BOARD_NAME}-${ENTER_os_ver}_${ENTER_rootfs_type}"
